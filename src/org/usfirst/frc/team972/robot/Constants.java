...
public class Constants {
	...
	public static final int LEFT_RED_LED_PORT = 2;
	public static final int LEFT_GREEN_LED_PORT = 3;
	public static final int LEFT_BLUE_LED_PORT = 4;
	public static final int RIGHT_RED_LED_PORT = 5;
	public static final int RIGHT_GREEN_LED_PORT = 6;
	public static final int RIGHT_BLUE_LED_PORT = 7;
	// USB Ports

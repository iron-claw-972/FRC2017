...
public class LeftModel {
	 ...
	 */
	public static void update(double powerToLeft, double dT, double frontEncoderDistance, double backEncoderDistance) { //TODO convert encoder clicks to actual distance

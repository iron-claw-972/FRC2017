...
public class Constants {
	...
	// Motor IDs
	public static final int FRONT_LEFT_DRIVE_MOTOR_CAN_ID_PORT = 0;
	public static final int FRONT_RIGHT_DRIVE_MOTOR_CAN_ID_PORT = 1;
	public static final int BACK_LEFT_DRIVE_MOTOR_CAN_ID_PORT = 2;
	public static final int BACK_RIGHT_DRIVE_MOTOR_CAN_ID_PORT = 3;
